...
function seedMemory(engine: MemoryEngine): void {
  const facts = [
    ...
    { content: 'The 22-layer memory system: L1 working, L2 episodic, L3 semantic, L4 procedural, L5 chronos, L6 resonance, L7 echo, L8 synapse, L9 sheaf + 13 advanced forge layers.', type: 'decision' as const },

...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::load_all_semantic,
            commands::load_all_episodes,
            commands::search_memory_all,
            ...
            nexus_bridge::load_unified_graph_all,
            ...
            connectors::connector_save_credentials,
            connectors::connector_open_console,

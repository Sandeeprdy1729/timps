...
export function getServerEchoForge(userId: number | string, projectId?: string) {
  return getEngine(userId, projectId).echoForge;
}

export const echoForge = getServerEchoForge(0, 'default');

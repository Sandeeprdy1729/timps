...
> TIMPS, AI कोडिंग एजेंटों के लिए एक स्थायी मेमोरी परत है। यह आपके कोडबेस, आपके निर्णय, आपकी बग्स को याद रखता है — ताकि Claude, Cursor, Windsurf, या कोई भी MCP-संगत एजेंट आपसे कभी कुछ दोबारा समझाने को न कहे। 9-परत मेमोरी। 17 इंटेलिजेंस टूल। 30 सेकंड में इंस्टॉल। मुफ्त।
...
- **🧠 9-परत स्थायी मेमोरी** — एपिसोडिक (सत्र पुनर्स्मरण), सीमैंटिक (ज्ञान ग्राफ), प्रोसिजरल (वर्कफ़्लो), साथ ही 6 उन्नत फोर्ज परतें (ChronosForge, ResonanceForge, EchoForge, SynapseQuench, HarmonicSheafWeaver, और अधिक)। मेमोरी सत्रों, प्रोजेक्ट्स और एजेंट रीस्टार्ट के बीच बनी रहती है।
- **🔧 17 इंटेलिजेंस टूल** — कॉन्ट्राडिक्शन डिटेक्शन, बर्नआउट पूर्वानुमान, रिलेशनशिप ट्रैकिंग, पैटर्न डिटेक्शन, एनॉमली स्कोरिंग, सीमैंटिक सर्च, ड्रिफ्ट डिटेक्शन, और अधिक। हर टूल क्लास-आधारित, डिटर्मिनिस्टिक (शून्य `Math.random()`) और बेंचमार्क किया हुआ है।
...
जब आप TIMPS से कोई प्रश्न पूछते हैं, तो अनुरोध 9-परत मेमोरी सिस्टम से होकर बहता है। प्रत्येक परत संदर्भ को समृद्ध करती है: वर्किंग मेमोरी तत्काल सत्र रखती है, एपिसोडिक पिछले सत्रों को याद करती है, सीमैंटिक ज्ञान ग्राफ संबंध प्रदान करती है, प्रोसिजरल सीखे गए वर्कफ़्लो को शामिल करती है, और फोर्ज परतें (5–9) समय-श्रृंखला विश्लेषण, रेज़ोनेंस मैचिंग, पैटर्न संश्लेषण, साहचर्य पुनर्स्मरण और हार्मोनिक वीविंग संभालती हैं। 17 इंटेलिजेंस टूल समृद्ध संदर्भ को संसाधित करते हैं, फिर एक प्रतिक्रिया लौटाते हैं जो TIMPS ने आपके कोडबेस के बारे में जो कुछ भी सीखा है, उस पर आधारित होती है।
...
- **"मैं एक बड़े मोनोरेपो का प्रबंधन करता हूँ और मेरा एजेंट संदर्भ भूलता रहता है।"** TIMPS की 9-परत मेमोरी किसी भी आकार के कोडबेस को संभालती है। फोर्ज परतें (ChronosForge, HarmonicSheafWeaver) दीर्घकालिक पैटर्न पहचान और क्रॉस-फ़ाइल रिलेशनशिप मैपिंग में विशेषज्ञ हैं।
...
सभी 17 इंटेलिजेंस टूल एक मानकीकृत मूल्यांकन सूट के विरुद्ध निरंतर बेंचमार्क किए जाते हैं। परिणाम प्रति-कमिट ट्रैक किए जाते हैं ताकि प्रतिगमन को रोका जा सके।

| मीट्रिक | TIMPS | agentmemory | सुधार |
|---|---|---|---|---|
| **R@5 (रिकॉल @ 5)** | ≥ 90% | ~75% | +15% |
| **MRR (मीन रेसिप्रोकल रैंक)** | 0.87 | 0.71 | +23% |
| **कॉन्ट्राडिक्शन सटीकता** | 94% | 82% | +12% |
| **एनॉमली प्रिसिजन** | 91% | — | — |
| **विलंबता (औसत, लोकल SQLite)** | 12 ms | 18 ms | -33% |
| **विलंबता (औसत, वेक्टर)** | 45 ms | 60 ms | -25% |
...
TIMPS में 9 मेमोरी परतें बनाम 1, 17 इंटेलिजेंस टूल बनाम 0, 7 प्रदाताओं का समर्थन बनाम 3, VS Code एक्सटेंशन, मोबाइल ऐप और प्लगइन सिस्टम शामिल है। agentmemory सरल और केवल-SQLite है।
...
|---|---|
| [`DOCS.md`](DOCS.md) | इंस्टॉलेशन, कॉन्फ़िग, CLI कमांड, मेमोरी API, MCP टूल |
| [`ARCHITECTURE.md`](ARCHITECTURE.md) | 9 मेमोरी परतें, 17 टूल, बेंचमार्क, CI, MCP आंतरिक |
...
| [`sandeep-ai/README.md`](sandeep-ai/README.md) | पूर्ण सर्वर + REST API |

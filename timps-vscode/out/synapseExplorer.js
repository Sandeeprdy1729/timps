...
exports.SynapseMetabolonExplorerProvider = void 0;
const synapseClient_1 = require("./synapseClient");
class SynapseMetabolonExplorerProvider {
    constructor(_extensionUri, userId = 1, apiBase = 'http://localhost:3000') {
        this._extensionUri = _extensionUri;
        this._userId = userId;
        this._apiBase = apiBase;
    }
    updateConfig(userId, apiBase) {
        this._userId = userId;
        this._apiBase = apiBase;
        this._refreshView();
    }
    ...
    async _loadData() {
        const [stats, graph] = await Promise.all([
            (0, synapseClient_1.getSynapseStats)(this._userId),
            (0, synapseClient_1.getSynapseGraph)(this._userId, 50),
        ]);
    ...
    async _handleQuery(query) {
        const result = await (0, synapseClient_1.querySynapseMetabolon)(query, this._userId);
        this._view?.webview.postMessage({
            type: 'queryResult',
    ...
    async _handleConsolidate() {
        const result = await (0, synapseClient_1.runConsolidationCycle)(this._userId);
        this._view?.webview.postMessage({
...
exports.SynapseMetabolonExplorerProvider = SynapseMetabolonExplorerProvider;
SynapseMetabolonExplorerProvider.viewType = 'timps.synapseMetabolonExplorer';

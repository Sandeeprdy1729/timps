...
exports.NexusForgeExplorerProvider = void 0;
const nexusClient_1 = require("./nexusClient");
class NexusForgeExplorerProvider {
    ...
    async _loadData() {
        const [stats, graph] = await Promise.all([
            (0, nexusClient_1.getNexusForgeStats)(this._userId),
            (0, nexusClient_1.getNexusForgeGraph)(this._userId, 50),
        ]);
    ...
    async _handleQuery(query) {
        const result = await (0, nexusClient_1.queryNexusForge)(query, this._userId);
        this._view?.webview.postMessage({
            type: 'queryResult',
...
exports.NexusForgeExplorerProvider = NexusForgeExplorerProvider;
NexusForgeExplorerProvider.viewType = 'timps.nexusForgeExplorer';

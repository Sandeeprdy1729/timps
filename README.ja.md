...
| 指標 | TIMPS | agentmemory | 改善率 |
|---|---|---|---|
| **R@5（5件中の再現率）** | ≥ 90% | ~75% | +15% |
| **MRR（平均相互順位）** | 0.87 | 0.71 | +23% |
| **矛盾検出精度** | 94% | 82% | +12% |
| **異常検出精度** | 91% | — | — |
| **レイテンシ（平均、ローカルSQLite）** | 12 ms | 18 ms | -33% |
| **レイテンシ（平均、ベクター）** | 45 ms | 60 ms | -25% |
...
| ファイル | 内容 |
|---|---|
| [`DOCS.md`](DOCS.md) | インストール、設定、CLIコマンド、メモリAPI、MCPツール |
...
| [`sandeep-ai/README.md`](sandeep-ai/README.md) | フルサーバー + REST API |
